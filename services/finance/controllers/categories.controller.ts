...
export const categoriesController = (app: Elysia) =>
  app.group("/categories", (app) =>
    app
      .get(
        "/",
        async ({ query }) => CategoriesService.list(query.accountId),
        {
          query: t.Object({ accountId: t.Optional(t.String()) }),
          response: t.Array(categoryResponse),
          detail: {
            tags: ["Categories"],
      ...
      .post(
        "/",
        async ({ body }) => CategoriesService.create(body),
        {
          body: categoryInput,
      ...
      .get(
        ...
        },
        {
          ...
          response: { 200: categoryResponse, 404: t.Object({ message: t.String() }) },
          detail: {
            tags: ["Categories"],
